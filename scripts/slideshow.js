var MESSAGES = {
  ...
  "photoviewer.toolbar.slideShow":   "Iniciar/Pause (Space)",
  ...
  "photoviewer.toolbar.close":       "Sair (Esc)",
  "photoviewer.email.subject.photo": "Foto",

  "gallery.nophotos":                "Nenhuma Foto",
  "gallery.thumbs.start":            "Iniciar",
  "gallery.thumbs.end":              "Ultima",
  "gallery.toolbar.first":           "Primeira Foto",
  "gallery.toolbar.prev":            "Foto Anterior",
  "gallery.toolbar.view":            "Ver Fotos",
  "gallery.toolbar.next":            "Proxima Foto",
  "gallery.toolbar.last":            "Ultima Foto",
  "gallery.view.full":               "Maximinizar Janela",
  "gallery.view.photo":              "Show Photo Only",
  "gallery.view.text":               "Show Description Only",
  "gallery.view.close":              "Fechar Janela"
};
...
(function($){
	$.fn.slideshow =  function(options){
		...
		if(options.setBackgroundColor)
			viewer.setBackgroundColor(options.setBackgroundColor);
		if(options.setBorderWidth)
			viewer.setBorderWidth(options.setBorderWidth);
		if(options.setFontSize)
			viewer.setFontSize(options.setFontSize);
		if(options.setShadeColor)
			viewer.setShadeColor(options.setShadeColor);							
		if(options.disableEmailLink)
			viewer.disableEmailLink(options.disableEmailLink);							
		if(options.disablePhotoLink)
			viewer.disablePhotoLink(options.disablePhotoLink);							
		if(options.enableAutoPlay)
			viewer.enableAutoPlay(options.enableAutoPlay);							
