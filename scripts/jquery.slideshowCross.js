...
---------------------------------
SlideShowCross jQuery plugin v1.0
Script baseado no CrossSlide
---------------------------------
*/

$(function(){
	$.fn.slideShowCross =  function(options){
		var defaults = {
			fade: 1,
			speed: 30
		}
		...
		return this.each(function(){
			...
			var onSlide = function onSlide(idx, img, idxOut, imgOut){
				//console.debug(idx);				
				if (idxOut == undefined){
					// starting single image phase, put up caption
					//alert(img.alt)
					$('div.caption').html(img.alt).fadeIn();
				}
				else{
			...
			$("div", this).each(function(index, value){
				var direcao = "up"; if((index % 2) == 0) direcao = "down";
				images.push({src: $("img",this).attr("src"), dir: direcao, alt: $("span",this).html(), href: $("a",this).attr("href"), time: 5});
			});
			
			$(this).empty().after("<div class='caption'>");
			$(this).crossSlide(options,images,onSlide);
		});
	}
});	